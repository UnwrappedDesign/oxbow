...
const flyouts: Template = {
  name: "Flyout menus",
  quantity: 1,
  link: "/playground/application/flyouts",
  image: "flyouts.png",
};
const megamenu: Template = {
  name: "Mega Menu",
  quantity: 1,
  link: "/playground/application/megamenu",
  image: "megamenu.png",
};
const sidebars: Template = {
  name: "Sidebars",
  quantity: 1,
  link: "/playground/application/sidebars",
  image: "sidebars.png",
};
const verticalnav: Template = {
...
// Elements
//
const banners: Template = {
  name: "Banners",
  quantity: 5,
  link: "/playground/marketing/banners",
  image: "banners.png",
};
