...
export default function GradientGenerator() {
  ...
  return (
    <div id="generator">
      <div className="z-10 bg-white lg:sticky lg:top-2 ">
        <div className="flex items-center bg-white ">
          <label className="sr-only">Mode</label>
          <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-2 ">
            <button
              className={`
                            flex items-center text-center justify-center   duration-500 ease-in-out transition-colors focus:outline-2 text-black bg-base-100 hover:bg-base-200 focus:outline-accent-500          h-10 px-6 py-3 text-base  rounded-lg w-full
            ...
            <button
              className="flex items-center justify-center w-full h-10 px-6 py-3 text-base text-center text-black rounded-lg  duration-500 ease-in-out transition-colors focus:outline-2 bg-base-100 hover:bg-base-200 focus:outline-accent-500"
        ...
        <div className="w-full pt-2 bg-white grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 ">
          {mode === "text" && (
        ...
        <div className="pt-2 bg-white ">
          <div
            className={`flex items-center justify-center relative w-full  lg:sticky  z-90  p-24 outline rounded-xl outline-base-100        overflow-hidden    ${generateTwGradient()}`}
          >
            {mode === "text" ? (
        ...
        <div className="flex items-center py-4 mt-2 bg-white  gap-x-2 outline rounded-xl outline-base-100">
          <button
            className={` flex items-center text-center justify-center  duration-500 ease-in-out transition-colors focus:outline-2 text-black bg-base-100 hover:bg-base-200 focus:outline-accent-500          h-10 px-6 py-3 text-base  rounded-lg w-full ${tab === "from" ? "!outline-base-500 " : ""}`}
            onClick={() => setTab("from")}
          >
            From Color
          </button>
          <button
            className={`  flex items-center text-center justify-center  duration-500 ease-in-out transition-colors focus:outline-2 text-black bg-base-100 hover:bg-base-200 focus:outline-accent-500          h-10 px-6 py-3 text-base  rounded-lg w-full ${tab === "to" ? "!outline-base-700" : ""}`}
            onClick={() => setTab("to")}
          >
            To Color
          </button>
      ...
      <div className="py-8 mt-4 bg-white  grid grid-cols-4 gap-x-4 md:grid-cols-8 gap-y-12 lg:grid-cols-12 outline rounded-xl outline-base-100">
