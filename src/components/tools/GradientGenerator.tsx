  ...
  return (
    <div id="generator">
      <div className="grid gap-3 lg:grid-cols-3">
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-2">
            <button
              className={`
                            flex items-center justify-center text-center shadow-subtle font-medium duration-500 ease-in-out transition-colors focus:outline-2 focus:outline-offset-2 text-base-900 bg-white hover:bg-base-100 focus:outline-base-900 h-9 px-4 py-2 text-sm rounded-md w-full
          ...
          <button
            className="flex items-center justify-center w-full px-4 py-2 text-sm font-medium text-center text-base-900 bg-white shadow-subtle duration-500 ease-in-out transition-colors focus:outline-2 focus:outline-offset-2 hover:bg-base-100 focus:outline-base-900 h-9 rounded-md"
        ...
        <div className="lg:col-span-2">
          <div
            className={`flex items-center justify-center relative h-full w-full p-12 md:p-20 rounded-lg overflow-hidden border border-base-100 ${
              mode === "background" ? "" : "bg-white "
            }`}
      ...
      <div className="flex items-center pt-4 gap-x-2">
          <button
            className={`flex items-center justify-center text-center shadow-subtle font-medium duration-500 ease-in-out transition-colors focus:outline-2 focus:outline-offset-2 text-base-900 bg-white hover:bg-base-100 focus:outline-base-900 h-9 px-4 py-2 text-sm rounded-md w-full ${tab === "from" ? "!outline-base-700 " : "text-base-500 "}`}
            onClick={() => setTab("from")}
          >
            From Color
          </button>
          <button
            className={`flex items-center justify-center text-center shadow-subtle font-medium duration-500 ease-in-out transition-colors focus:outline-2 focus:outline-offset-2 text-base-900 bg-white hover:bg-base-100 focus:outline-base-900 h-9 px-4 py-2 text-sm rounded-md w-full disabled:opacity-40 ${tab === "via" ? "!outline-base-700 " : "text-base-500 "}`}
            onClick={() => setTab("via")}
            disabled={!useVia}
          >
            Via Color
          ...
          <button
            className={`flex items-center justify-center text-center shadow-subtle font-medium duration-500 ease-in-out transition-colors focus:outline-2 focus:outline-offset-2 text-base-900 bg-white hover:bg-base-100 focus:outline-base-900 h-9 px-4 py-2 text-sm rounded-md w-full ${tab === "to" ? "!outline-base-700 " : "text-base-500 "}`}
            onClick={() => setTab("to")}
          >
            To Color
          </button>
      ...
      <div className="p-6 mt-4 bg-white rounded-lg flex flex-col gap-8 outline   outline-base-100 ">
        {colorFamilies.map((family) => (
          <div key={family}>
            <p className=" text-xs uppercase text-base-500 ">
              {family}
            </p>
              ...
              {makeStopsForFamily(family).map((stop) => {
                ...
                return (
                  ...
                  <button
                    ...
                    className={`p-4 rounded-lg w-full h-full focus:outline-none ring-offset-4 focus:ring-offset-base-950 focus:ring-white duration-300 ${isSelected ? "ring-2" : ""}`}
                    onClick={() => {
                  ...
                  />
                  <p className="text-xs uppercase text-base-500 mt-1">
                    {stop.shade}
                  </p>
                </div>
                );
