...
- Using the components to develop unlimited End products.
- Modifying the components to create derivative components, which are also covered by this license.
- Using the components to produce unlimited End products for any number of Clients.
- Creating End products with the components that are sold to end users.
- Developing End products with the components that are open-source and freely accessible to end users.
...
**You can**
- Employ the components to generate unlimited End products.
- Adapt the components to create derivative components, all governed by this license.
- Create limitless End products for various clients.
- Develop End products for sale to end users.
- Construct End products that are open source and available to end users at no cost.

**You cannot**
- Utilize the components to produce End products facilitating end users to build their own using the components or their derivatives.
...
**Employee** — A full-time or part-time worker of the licensee.

**Contractor** — An individual or business entity contracted to provide services to the Licensee.
...
Windtatic will not be responsible for any outcome that may occur during the course of usage of our resources.
...
If you have any questions, please email me at [michael@andreuzza.comm](mailto:michael@andreuzza.com).